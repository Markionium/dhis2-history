	...
	implements Serializable
{
    ...
    public PatientDataValue( Encounter encounter, DataElement dataElement, DataElementCategoryOptionCombo optionCombo, String value )
    {
    	this.encounter = encounter;
    	this.dataElement = dataElement;
        this.optionCombo = optionCombo;
    ...
    public boolean equals( Object o )
    {
        ...
        return encounter.equals( other.getEncounter() ) && 
