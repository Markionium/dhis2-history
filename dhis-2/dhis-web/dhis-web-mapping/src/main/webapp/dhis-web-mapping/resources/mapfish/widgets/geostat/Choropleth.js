            ...
            listeners: {
                'select': {
                    fn: function() {
                        ...
                        Ext.getCmp('dataelement_cb').reset();
                        dataElementGroupStore.baseParams = { dataElementGroupId: Ext.getCmp('dataelementgroup_cb').getValue() };
                        dataElementGroupStore.reload();
                    },
                    scope: this
                }
            }
...
// alert(		Ext.getCmp('valuetype_cb').getValue());
