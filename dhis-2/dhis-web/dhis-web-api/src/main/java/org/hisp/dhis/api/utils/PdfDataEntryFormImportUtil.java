...
public class PdfDataEntryFormImportUtil
{
        ...
        throws IOException, Exception
    {
        ...
        Calendar execuateDateCal = Calendar.getInstance();
        execuateDateCal.setTime( executionDateInput );
            ...
            .getProgramStageInstanceData().entrySet() )
        {
            ...
            execuateDateCal.set( Calendar.DATE, date );
            Date executionDate = execuateDateCal.getTime();
