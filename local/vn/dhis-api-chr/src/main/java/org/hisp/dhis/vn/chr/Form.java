...
public class Form implements java.io.Serializable {
	...
	public Form(String name, String label, int noColumn, int noColumnLink,
			boolean visible, boolean created) {
		this.name = name;
		this.label = label;
	...
	public Form(String name, String label, int noColumn, int noColumnLink,
			String icon, boolean visible, boolean created,
			Collection<Element> elements, Collection<Egroup> egroups) {
		this.name = name;
		this.label = label;
		this.noColumn = noColumn;
		this.noColumnLink = noColumnLink;
