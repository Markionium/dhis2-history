...
public class AddDataStatement extends FormStatement {
	...
	protected void init(Form form) {
		...
		buffer.append(columns + "id" + SEPARATOR + SPACE + "createddate" + SEPARATOR + SPACE + "editeddate" + SEPARATOR + SPACE +"addby)" + SPACE);
		
		//buffer.append(values + "'" + System.identityHashCode(values) + "','" + USERS.iterator().next().getId() + "')" + SPACE);
		buffer.append(values + "'" + ((int)(System.currentTimeMillis())) + "'" + SEPARATOR + SPACE + "'" + new Date() + "'"+ SEPARATOR + SPACE + "'" + new Date() + "'"+ SEPARATOR + SPACE +"'" + USERS.iterator().next().getId() + "')" + SPACE);
