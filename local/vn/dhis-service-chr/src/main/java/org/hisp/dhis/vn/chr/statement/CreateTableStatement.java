...
public class CreateTableStatement extends FormStatement{
	...
	protected void init(Form form) {
		...
		// id INTEGER ;
//        buffer.append("id" + SPACE + Element.INTEGER + SPACE + REQUIRED + SEPARATOR);
...
//            	System.out.print("CONSTRAINT"+ SPACE +  form.getName()+"_"+ column.getFormLink().getName() + "_" + System.currentTimeMillis()+ SPACE + "FOREIGN KEY(" + SPACE + column.getName()+ SPACE + ")"+ SPACE + "REFERENCES"+ column.getFormLink().getName()+ "(id)");
            	buffer.append("CONSTRAINT"+ SPACE +  form.getName()+"_"+ column.getFormLink().getName() + "_" + System.currentTimeMillis()+ SPACE + "FOREIGN KEY(" + SPACE + column.getName()+ SPACE + ")" + SPACE  + "REFERENCES"+ SPACE + column.getFormLink().getName() + SPACE +"(id)" + SEPARATOR + SPACE);
            }
